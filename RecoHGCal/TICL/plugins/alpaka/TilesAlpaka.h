...
namespace ALPAKA_ACCELERATOR_NAMESPACE {
  ...
  public:
    ...
    ALPAKA_FN_HOST_ACC inline constexpr const float* minMax() const { return min_max.data(); }
    ALPAKA_FN_HOST_ACC inline constexpr float* minMax() { return min_max.data(); }

    ALPAKA_FN_HOST_ACC inline constexpr const float* tileSize() const { return tile_size; }
    ...
    template <typename TAcc>
    ALPAKA_FN_HOST_ACC inline constexpr int getGlobalBinByBin(const TAcc&, const VecArray<uint32_t, Ndim>& Bins) const {
