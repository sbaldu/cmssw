...
namespace cms::soa {
  ...
  struct SoAParametersImpl {
    ...
    template <typename U>
      requires std::same_as<std::remove_cvref_t<U>, ValueType>
    SOA_HOST_DEVICE SOA_INLINE constexpr SoAParametersImpl(SoAParametersImpl<COLUMN_TYPE, U> params)
  ...
  struct SoAParametersImpl<SoAColumnType::eigen, T> {
    ...
    template <typename U>
      requires std::same_as<std::remove_cvref_t<U>, ValueType>
    SOA_HOST_DEVICE SOA_INLINE constexpr SoAParametersImpl(SoAParametersImpl<SoAColumnType::eigen, U> params)
